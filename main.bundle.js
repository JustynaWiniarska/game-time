...
/***/ function(module, exports, __webpack_require__) {
	...
	class World {
	  constructor() {
	    ...
	    this.blockDestroySound = new Audio("sounds/hoha.mp3");
	    this.paddleSound = new Audio("sounds/suh.mp3");
	    this.winSound = new Audio("sounds/lit.mp3");
	  }
	  ...
	  newLevel(ctx) {
	    if (this.score == 4 && this.level == 1 || this.score == 8 && this.level == 2) {
	      this.level++;
	      this.levelUpdate();
	      this.newLevelDraw(ctx);
	    } else if (this.score == 12 && this.level == 3) {
	      this.winGame(ctx);
	    }
	  }
